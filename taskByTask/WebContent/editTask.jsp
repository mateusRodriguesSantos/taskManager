        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-8" >
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="title" value="<c:out value="${Task.titulo}"/>">
            ...
            <div class="col-md-8 mt-5">
                <h5>Description</h5>
                <div class="form-group">
                    <textarea class="form-control textarea" name="description" id="" cols="" rows="">
            ...
            <div class="col-md-8 mt-5">
                <div class="row">
                    <div class="col-md-3">
                        <h5>Date Limite</h5>
                        <div class="form-group">
                            <input class="form-control" name="date" type="date" value="${Task.limite}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <h5>Priority</h5>
                ...
                <div class="col">
                    <ol id="checklist">
                    	<c:forEach items="${listCheck}" var="item">
	                        <li id="check${item.idTask}" class="mb-5"> ${item.name}
	                        	<input type="hidden" name="check" value="${item.name}"/>
	                            <button onclick="removeElement(${item.idTask})" type="button" class="btnRemove btn btn-primary" style="float:right; background-color: red;">-</button>                        	
	                        </li>
                        </c:forEach>
                    </ol>
                </div>
    ...
    <script>
        function addChecklist(){
            ...
            if (text == null || text == "") {
                ...
                '<input type="hidden" name="check" value="'+txt+'"/>'+ 
